...
class _$NotificationStateImpl implements _NotificationState {
  const _$NotificationStateImpl(
      ...
      final List<Notification> unreadNotifications = const []})
  ...
  final List<Notification> _unreadNotifications;
  @override
  @JsonKey()
  List<Notification> get unreadNotifications {
  ...
  @override
  String toString() {
    return 'NotificationState(status: $status, notifications: $notifications, unreadNotifications: $unreadNotifications)';
  }
...
abstract class _NotificationState implements NotificationState {
  const factory _NotificationState(
      ...
      final List<Notification> unreadNotifications}) = _$NotificationStateImpl;
