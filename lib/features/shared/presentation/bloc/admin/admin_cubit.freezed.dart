...
mixin _$AdminState {
  ...
  AdminConfigResponse? get adminConfig => throw _privateConstructorUsedError;
...
abstract class $AdminStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({BaseStatus<dynamic> status, AdminConfigResponse? adminConfig});
...
class _$AdminStateCopyWithImpl<$Res, $Val extends AdminState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      adminConfig: freezed == adminConfig
          ? _value.adminConfig
          : adminConfig // ignore: cast_nullable_to_non_nullable
...
class _$AdminStateImpl implements _AdminState {
  const _$AdminStateImpl(
      {this.status = const BaseStatus.initial(), this.adminConfig});

  @override
  @JsonKey()
  final BaseStatus<dynamic> status;
  @override
  final AdminConfigResponse? adminConfig;

  @override
  String toString() {
    return 'AdminState(status: $status, adminConfig: $adminConfig)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.adminConfig, adminConfig) ||
                other.adminConfig == adminConfig));
  }

  @override
  int get hashCode => Object.hash(runtimeType, status, adminConfig);
...
abstract class _AdminState implements AdminState {
  const factory _AdminState(
      {final BaseStatus<dynamic> status,
      final AdminConfigResponse? adminConfig}) = _$AdminStateImpl;

  @override
  BaseStatus<dynamic> get status;
  @override
  AdminConfigResponse? get adminConfig;
